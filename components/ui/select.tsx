...
>(({ className, children, error, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'flex w-full items-center justify-between px-4 py-3 rounded-xl border bg-white text-sm',
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn('py-1.5 pl-3 pr-2 text-xs font-semibold text-neutral-400 uppercase tracking-wide', className)}
    {...props}
  />
))
